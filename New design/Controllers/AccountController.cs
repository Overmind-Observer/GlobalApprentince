...
namespace Global_Intern.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IOptions<EmailSettings> emailSetting, ICustomAuthManager auth,
            IWebHostEnvironment env, IHttpContextAccessor httpContextAccessor, IConfiguration iConfig)
        {
        ...
        // ==========all new sign up pages============// 

        public IActionResult RegisterStudent( )
        {  
           string recaptchakey = configuration.GetValue<string>("recaptcha:recaptchakey");
            ViewBag.key = recaptchakey;
            return View();
        }

        [HttpPost]
        public IActionResult RegisterStudent(RegisterationStudent student)
        {

            if (ModelState.IsValid)
            {
                ViewBag.Message = " Student sign up  sucessfully";
                return View();
            }
        ...
        [HttpPost]
        public IActionResult RegisterEmployer(RegisterationEmployer employer)
        {
            if (ModelState.IsValid)
            {
                ViewBag.Message = " Employer sign up  sucessfully";
                return View();
            }
        ...
        [HttpPost]
        public IActionResult RegisterInstitute(RegisterationInstitue institue)
        {

            if (ModelState.IsValid)
            {
                ViewBag.Message = " Institue sign up sucessfully";
                return View();
            }
        ...
        [HttpPost]
        public IActionResult RegisterSupervisor(RegisterationSupervisor supervisor)
        {

            if (ModelState.IsValid)
            {
                ViewBag.Message = " Supervisor sign up  sucessfully";
                return View();
            }
