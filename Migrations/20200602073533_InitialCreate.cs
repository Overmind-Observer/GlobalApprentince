        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserEmailVerified = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InternshipId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InternshipTitle = table.Column<string>(nullable: true),
                    InternshipType = table.Column<string>(nullable: true),
                    InternshipDuration = table.Column<string>(nullable: true),
                    InternshipBody = table.Column<string>(nullable: true),
                    InternshipVirtual = table.Column<bool>(nullable: false),
                    InternshipExperienceLevel = table.Column<string>(nullable: true),
